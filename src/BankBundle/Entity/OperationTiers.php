 ...
 *
 *
 * @ORM\Table(name="operation_tiers")
 * @ORM\Entity(repositoryClass="BankBundle\Repository\OperationTiersRepository")
 */
class OperationTiers
{
    /**
     * @var integer
     *
    ...
    /**
     * @var Operation[]
     * @ORM\OneToMany(targetEntity="BankBundle\Entity\Operation",mappedBy="tiers")
     */
